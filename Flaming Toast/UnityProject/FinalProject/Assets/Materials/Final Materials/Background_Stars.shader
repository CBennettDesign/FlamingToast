...
////// Emissive:
                ...
                float2 node_3083 = (i.uv0+node_4795.g*float2(0.02,0));
                ...
                float3 emissive = (1.0*(saturate((1.0-(1.0-saturate((1.0-(1.0-saturate((1.0-(1.0-float3(0,0,0))*(1.0-(node_3953.a*2.0)))))*(1.0-(_node_3953_copy.b*3.5)))))*(1.0-(_node_3953_copy_copy.g*10.0))))+(node_8430/(1.0-node_8430))));
