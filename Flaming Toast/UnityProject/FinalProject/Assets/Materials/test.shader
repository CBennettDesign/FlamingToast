...
////// Lighting:
////// Emissive:
                float4 node_4440 = _Time;
                float2 _pan_var = lerp( i.uv0, (i.uv0+node_4440.g*float2(1,0.1)), _pan );
                ...
                float node_7888 = saturate(abs(node_9107-(-1*node_9107)));
                fixed4 finalRGBA = fixed4(finalColor,((1.0 - saturate(lerp( 1.0, (_verticalblendamount*node_7888), _verticalblend )))*_opacity*i.vertexColor.a));
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : SV_Target {
                ...
                float4 node_836 = _Time;
                float2 _pan_var = lerp( i.uv0, (i.uv0+node_836.g*float2(1,0.1)), _pan );
                float4 _mask_var = tex2D(_mask,TRANSFORM_TEX(_pan_var, _mask));
